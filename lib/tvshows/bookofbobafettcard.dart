                          ...
                          child: ClipOval(
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _bookOfBobaFettNavigator(context);
                                },
                                child: bookOfBobaFettSeasons(),
                              ),
                            ),
                          ),
                        ),
...
_bookOfBobaFettNavigator(BuildContext context) {
  return Navigator.push(
    ...
    MaterialPageRoute<void>(
      builder: (BuildContext context) {
        return Scaffold(
          appBar: AppBar(
            title: Text("The Book Of Boba Fett"),
            backgroundColor: Colors.lightGreen[900],
          ),
          body: bookOfBobaFettBody(),
        );
      },
    ),
  );
