...
_nextGeneration(BuildContext context, String season_num) {
  ...
  Future<List<dynamic>> fetchTNG() async {
    ...
    final String api1Url = "http://192.168.0.93:8080/intTNG?season=01";
    final String api2Url = "http://192.168.0.93:8080/intTNG?season=02";
    final String api3Url = "http://192.168.0.93:8080/intTNG?season=03";
    final String api4Url = "http://192.168.0.93:8080/intTNG?season=04";
    final String api5Url = "http://192.168.0.93:8080/intTNG?season=05";
    final String api6Url = "http://192.168.0.93:8080/intTNG?season=06";
    final String api7Url = "http://192.168.0.93:8080/intTNG?season=07";
