...
class YTheLastManCard extends StatelessWidget {
  @override
                          ...
                          child: ClipOval(
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _ythelastNavigator(context);
                                }, // button pressed
                                child: ythelastButtonColumn(),
                              ),
                            ),
                          ),
                        ),
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              onTap: () {
                                ...
                                String ap =
                                    dirp + snapshot.data[index]["tvfspath"];
                                final String apiPU =
