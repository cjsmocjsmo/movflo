              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(children: <Widget>[
                    _orevilleNavigator(context, "1"),
                    _orevilleNavigator(context, "2"),
                    _orevilleNavigator(context, "3"),
                  ]),
                ),
              ),
            ]),
...
_orevilleNavigator(BuildContext context, String snum) {
  return Padding(
      ...
      child: ClipOval(
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: () {
              _orville(context, snum);
            },
            child: _orvilleButtonColumn(snum),
          ),
        ),
      ),
    ),
