...
_forAllManKind(BuildContext context, String season_num) {
  ...
  Future<List<dynamic>> fetchForAllManKind() async {
    ...
    final String api1Url = "http://192.168.0.93:8888/intForAllManKind?season=01";
    final String api2Url = "http://192.168.0.93:8888/intForAllManKind?season=02";
    if (season_num == '1') {
    ...
    // final String api3Url = "http://192.168.0.93:8888/intForAllManKind?season=03";
