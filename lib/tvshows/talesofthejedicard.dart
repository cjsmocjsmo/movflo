...
class TalesOfTheJediCard extends StatelessWidget {
  @override
                          ...
                          child: ClipOval(
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  talesOfTheJediNavigator(context);
                                },
                                child: seasons(),
                              ),
                            ),
...
Widget talesOfTheJediImage() {
  return Image.asset(
    'images/tales_of_the_jedi.webp',
    fit: BoxFit.contain,
    height: 355.5,
    width: 200.0,
  );
...
talesOfTheJediNavigator(BuildContext context) {
      ...
      builder: (BuildContext context) {
        return Scaffold(
          ...
          body: Container(
            ...
            child: Center(
              child: _talesOfTheJediFutureBuilder(),
            ),
          ),
        );
      },
