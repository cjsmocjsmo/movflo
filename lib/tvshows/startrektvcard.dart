              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        _starTrekSeasons(context, "1"),
                        _starTrekSeasons(context, "2"),
                        _starTrekSeasons(context, "3"),
                      ],
                    ),
                  ),
                ),
...
_starTrekSeasons(BuildContext context, String snum) {
  return Padding(
