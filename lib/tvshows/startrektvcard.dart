...
_sttv(BuildContext context, String season_num) {
  ...
  Future<List<dynamic>> fetchSTTVSeason1() async {
    ...
    final String api1Url = "http://192.168.0.91:8888/intSTTV?season=01";
    final String api2Url = "http://192.168.0.91:8888/intSTTV?season=02";
    final String api3Url = "http://192.168.0.91:8888/intSTTV?season=03";
...
_sttvButtonColumn(String episode) {
  return Column(
