...
class MastersOfTheUniverseCard extends StatelessWidget {
  // final String apiUrl =
  //     "http://192.168.0.94:8888/intMastersOfTheUniverse?season=01";
                          ...
                          child: ClipOval(
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _mastersNavigator(context);
                                },
                                child: mastersButtonColumn(),
                              ),
                            ),
                          ),
                        ),
...
_mastersNavigator(BuildContext context) {
  final String apiUrl =
      "http://192.168.0.94:8888/intMastersOfTheUniverse?season=01";
