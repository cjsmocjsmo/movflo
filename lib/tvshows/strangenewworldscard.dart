...
class StrangeNewWorldsCard extends StatelessWidget {
  @override
                          ...
                          child: ClipOval(
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _strangeNewWorldsNavigator(context);
                                },
                                child: strangeNewWorldsButtonColumn(),
                              ),
                            ),
                          ),
                        ),
...
Widget strangeNewWorldsButtonColumn() {
  return Column(
