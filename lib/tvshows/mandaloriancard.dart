...
class MandalorianCard extends StatelessWidget {
  ...
  Future<List<dynamic>> fetchMandalorianSeason2() async {
  ...
  final String api3Url = "http://192.168.0.42:8888/intMandalorian?season=03";

  Future<List<dynamic>> fetchMandalorianSeason3() async {
                                        ...
                                        child: Center(
                                          child:
                                            FutureBuilder<List<dynamic>>(
                                              future: fetchMandalorianSeason1(),
                                    ...
                                    return Scaffold(
                                      ...
                                      body: Container(
                                        ...
                                        child: Center(
                                          child:
                                            FutureBuilder<List<dynamic>>(
                                              future: fetchMandalorianSeason2(),
                                              builder: (BuildContext context,AsyncSnapshot snapshot) {
                                                if (snapshot.hasData) {
                                                  return ListView.builder(
                                                    padding: const EdgeInsets.all(8),
                                    ...
                                    return Scaffold(
                                      ...
                                      body: Container(
                                        ...
                                        child: Center(
                                          child:
                                            FutureBuilder<List<dynamic>>(
                                              future: fetchMandalorianSeason3(),
                                              builder: (BuildContext context,AsyncSnapshot snapshot) {
                                                if (snapshot.hasData) {
                                                  return ListView.builder(
                                                    padding: const EdgeInsets.all(8),
