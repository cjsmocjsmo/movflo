...
_mandalorian(BuildContext context, String season_num) {
  ...
  Future<List<dynamic>> fetchMandalorian() async {
    final String api1Url = "http://192.168.0.91:8888/intMandalorian?season=01";
    final String api2Url = "http://192.168.0.91:8888/intMandalorian?season=02";
    if (season_num == '1') {
    ...
    // final String api3Url = "http://192.168.0.91:8888/intMandalorian?season=03";
