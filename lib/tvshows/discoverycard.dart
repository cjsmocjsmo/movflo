...
_discovery(BuildContext context, String season_num) {
  ...
  Future<List<dynamic>> fetchDiscoverySeason() async {
    final String api1Url = "http://192.168.0.91:8888/intDiscovery?season=01";
    final String api2Url = "http://192.168.0.91:8888/intDiscovery?season=02";
    final String api3Url = "http://192.168.0.91:8888/intDiscovery?season=03";
    if (season_num == "1") {
