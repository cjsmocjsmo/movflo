    ...
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          child: Row(
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                  final String apiPrevious = "http://192.168.0.91:8181/Previous";
              ...
              IconButton(
                ...
                onPressed: () {
                  final String apiNext = "http://192.168.0.91:8181/Next";
                  nextMov(apiNext);
                },
              ),
              Spacer(),
        ...
        floatingActionButton:
          ...
          onPressed: () { 
            final String apiStop = "http://192.168.0.91:8181/Stop";
            stopMov(apiStop); 
          }
        ),
